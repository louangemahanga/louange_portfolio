...
class Invoice(models.Model):
    # name invoice model definition Description, author:mahangalouange757@gmail.com
...
class articles(models.Model):
    # name: article models definition descritpion
...
@property
def get_total(self):
    total = self.quantuty * self.unit_price
